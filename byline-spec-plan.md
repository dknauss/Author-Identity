...
For how existing multi-author plugins handle (or fail to handle) feed output, see [multi-author-matrix.md § Feed output comparison](multi-author-matrix.md#feed-output-comparison).
