...
Byline (bylinespec.org) is an extension vocabulary for RSS, Atom, and JSON Feed (v0.1.0, January 2026, CC0 licensed) that adds structured author identity, context, and content perspective metadata. It was created by Terry Godier to address "content collapse" — the loss of context when diverse content sources arrive in a unified feed reader stream.
...
Being the first CMS plugin to implement Byline would give this fork influence over how the extension evolves. Byline is CC0 licensed and at v0.1.0 — early implementors always shape extension vocabularies.
...
Byline explicitly states: "Always include standard elements for maximum compatibility. Byline is additive."
