...
Feed output is uniformly weak across all existing plugins. This is the core problem the [Byline extension vocabulary](byline-spec-plan.md) and the [Byline Feed plugin](byline-feed/) address.
...
- [byline-adoption-strategy.md](byline-adoption-strategy.md) — Byline adoption strategy
