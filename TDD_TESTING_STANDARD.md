...
- Byline conformance: required attributes and children present, vocabulary values valid, empty fields omitted not empty-element.
...
- PHPCS clean.
- If the PR touches feed output: XML well-formedness and Byline conformance tests pass.
